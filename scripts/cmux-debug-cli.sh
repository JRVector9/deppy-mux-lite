...
cli_path="${HOME}/Library/Developer/Xcode/DerivedData/cmux-${tag_slug}/Build/Products/Debug/deppy-mux-beta.app/Contents/Resources/bin/cmux"
if [[ ! -x "$cli_path" ]]; then
  cat >&2 <<EOF
...
export CMUX_BUNDLE_ID="com.deppy-mux.app.debug.${tag_bundle_id}"
