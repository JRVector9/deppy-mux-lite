...
DOWNLOAD_URL_PREFIX="${DOWNLOAD_URL_PREFIX:-https://github.com/JRVector9/deppy-mux-lite/releases/download/$TAG/}"
RELEASE_NOTES_URL="${RELEASE_NOTES_URL:-https://github.com/JRVector9/deppy-mux-lite/releases/tag/$TAG}"
