...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "automation:port-base": localized("settings.search.alias.setting.automation.port-base", defaultValue: "automation.portBase dodomux_port start first base env environment variable"),
        "automation:port-range": localized("settings.search.alias.setting.automation.port-range", defaultValue: "automation.portRange dodomux_port_end range size count env ports"),
        ...
        "keyboardShortcuts:shortcut-chords": localized("settings.search.alias.setting.keyboardShortcuts.shortcut-chords", defaultValue: "tmux prefix ctrl-b control-b multi key sequence chord dodomux json"),
        ...
        "keyboardShortcuts:shortcuts": localized("settings.search.alias.setting.keyboardShortcuts.shortcuts", defaultValue: "hotkeys keybindings key bindings commands keyboard accelerators shortcuts dodomux json"),
        ...
        "settingsJSON:open-file": localized("settings.search.alias.setting.settingsJSON.open-file", defaultValue: "open config file json jsonc config editor ~/.config dodomux preferences"),
        "settingsJSON:documentation": localized("settings.search.alias.setting.settingsJSON.documentation", defaultValue: "docs documentation schema reference dodomux json keys configuration"),
