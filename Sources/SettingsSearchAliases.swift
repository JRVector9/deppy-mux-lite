...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "mobile:webAccess": localized("settings.search.alias.setting.mobile.webAccess", defaultValue: "web connect access pwa browser link public url iphone ipad ios mobile terminal remote"),
        ...
        "automation:port-base": localized("settings.search.alias.setting.automation.port-base", defaultValue: "automation.portBase deppy-mux_port start first base env environment variable"),
        "automation:port-range": localized("settings.search.alias.setting.automation.port-range", defaultValue: "automation.portRange deppy-mux_port_end range size count env ports"),
        ...
        "keyboardShortcuts:shortcut-chords": localized("settings.search.alias.setting.keyboardShortcuts.shortcut-chords", defaultValue: "tmux prefix ctrl-b control-b multi key sequence chord deppy-mux json"),
        ...
        "keyboardShortcuts:shortcuts": localized("settings.search.alias.setting.keyboardShortcuts.shortcuts", defaultValue: "hotkeys keybindings key bindings commands keyboard accelerators shortcuts deppy-mux json"),
        ...
        "settingsJSON:open-file": localized("settings.search.alias.setting.settingsJSON.open-file", defaultValue: "open config file json jsonc config editor ~/.config deppy-mux preferences"),
        "settingsJSON:documentation": localized("settings.search.alias.setting.settingsJSON.documentation", defaultValue: "docs documentation schema reference deppy-mux json keys configuration"),
