...
enum SettingsNavigationTarget: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .settingsJSON:
            return String(localized: "settings.section.settingsJSON", defaultValue: "deppy-mux.json")
        case .reset:
...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "supported-file-previews", String(localized: "settings.app.openSupportedFilesInCmux", defaultValue: "Open Supported Files in deppy-mux"), "cmd click file preview pdf image audio video quick look editor"),
        ...
        setting(.app, "markdown-viewer", String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in deppy-mux Viewer"), "md markdown viewer"),
        ...
        setting(.sidebarAppearance, "open-pr-links", String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in deppy-mux Browser"), "pull request link browser"),
        setting(.sidebarAppearance, "open-port-links", String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in deppy-mux Browser"), "port link browser"),
        ...
        setting(.browser, "enable-browser", String(localized: "settings.browser.enabled", defaultValue: "Enable deppy-mux Browser"), "webview tabs links"),
        ...
        setting(.browser, "terminal-links", String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in deppy-mux Browser"), "click links browser"),
        ...
        setting(.settingsJSON, "open-file", String(localized: "settings.settingsJSON.openFile", defaultValue: "Open deppy-mux.json"), "config json file editor dotfiles"),
