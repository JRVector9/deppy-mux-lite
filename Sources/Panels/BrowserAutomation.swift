        ...
        case .destinationProfileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No dodomux browser profile matches '%@'"
                ),
                query
            )
        case .destinationProfileCreationFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to create dodomux browser profile '%@'"
                ),
                name
            )
        }
        ...
        case .ambiguousProfile(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Multiple dodomux browser profiles match '%@'. Use the profile ID instead."
                ),
                query
            )
        ...
        case .profileRenameFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to rename dodomux browser profile to '%@'"
                ),
                name
            )
        case .cannotDeleteDefaultProfile:
        ...
        case .profileInUse(let name, let count):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Cannot delete dodomux browser profile '%@' while %d browser panel(s) are using it"
                ),
                name,
                count
            )
        case .profileDeleteFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to delete dodomux browser profile '%@'"
                ),
                name
            )
        case .profileClearFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to clear dodomux browser profile '%@'"
                ),
                name
            )
        }
