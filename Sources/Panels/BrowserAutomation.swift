        ...
        case .destinationProfileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No deppy-mux browser profile matches '%@'"
                ),
                query
            )
        case .destinationProfileCreationFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to create deppy-mux browser profile '%@'"
                ),
                name
            )
        }
        ...
        case .ambiguousProfile(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Multiple deppy-mux browser profiles match '%@'. Use the profile ID instead."
                ),
                query
            )
        ...
        case .profileRenameFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to rename deppy-mux browser profile to '%@'"
                ),
                name
            )
        case .cannotDeleteDefaultProfile:
        ...
        case .profileInUse(let name, let count):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Cannot delete deppy-mux browser profile '%@' while %d browser panel(s) are using it"
                ),
                name,
                count
            )
        case .profileDeleteFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to delete deppy-mux browser profile '%@'"
                ),
                name
            )
        case .profileClearFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to clear deppy-mux browser profile '%@'"
                ),
                name
            )
        }
