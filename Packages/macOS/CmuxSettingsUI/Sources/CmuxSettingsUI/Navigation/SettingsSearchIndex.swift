...
public struct SettingsSearchIndex: Sendable {
    ...
    public init(
        ...
        for section in SettingsSectionID.allCases where featureAvailability.isSectionVisible(section) {
            built.append(Entry(
        ...
        for entry in curatedEntries where featureAvailability.isCuratedEntryVisible(entry) {
