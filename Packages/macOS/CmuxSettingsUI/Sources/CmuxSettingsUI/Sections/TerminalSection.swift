        ...
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                subtitle: scrollBar.current
                    ? String(localized: "settings.terminal.scrollBar.subtitleOn", defaultValue: "Shows the right-edge terminal scroll bar in shell scrollback. dodomux hides it automatically for alternate-screen style TUI surfaces.")
            ...
            SettingsCardRow(
                ...
                subtitle: copyOnSelect.current
                    ...
                    : String(localized: "settings.terminal.copyOnSelect.subtitleOff", defaultValue: "dodomux does not add system-clipboard copy on selection. Ghostty config still controls Paste Selection.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: autoResume.current
                    ? String(localized: "settings.terminal.agentAutoResume.subtitleOn", defaultValue: "When dodomux reopens after quit, restored agent terminals automatically run their resume command.")
                    : String(localized: "settings.terminal.agentAutoResume.subtitleOff", defaultValue: "When dodomux reopens after quit, restored agent terminals stay idle until you resume them manually.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: hibernation.current
                    ...
                    : String(localized: "settings.terminal.agentHibernation.subtitleOff", defaultValue: "Agent terminals stay live until you close them or quit dodomux.")
            ) {
