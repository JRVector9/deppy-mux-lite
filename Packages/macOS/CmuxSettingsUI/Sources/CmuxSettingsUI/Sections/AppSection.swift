...
public struct AppSection: View {
    ...
    private var globalFontMagnificationSubtitle: String {
        ...
        return String(
            ...
            defaultValue: "Scale every font in deppy-mux by the same percentage. 100% = design size."
        )
    }
        ...
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                subtitle: languageAtAppear != nil && language.current != languageAtAppear
                    ? String(localized: "settings.app.language.restartSubtitle", defaultValue: "Restart deppy-mux to apply")
                    : nil,
            ...
            SettingsCardRow(
                ...
                subtitle: firstClick.current
                    ? String(localized: "settings.app.paneFirstClickFocus.subtitleOn", defaultValue: "When deppy-mux is inactive, clicking a pane activates the window and focuses that pane in one click.")
                    : String(localized: "settings.app.paneFirstClickFocus.subtitleOff", defaultValue: "When deppy-mux is inactive, the first click only activates the window. Click again to focus the pane.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.configWindow.subtitle", defaultValue: "Open the deppy-mux terminal config and generated preview in one utility window."),
                controlWidth: Self.columnWidth
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.menuBarOnly.subtitle", defaultValue: "Hide the Dock icon and Cmd+Tab entry. Use the menu bar item to show deppy-mux.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.showInMenuBar.subtitle", defaultValue: "Keep deppy-mux in the menu bar for unread notifications and quick actions.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.notifications.paneFlash.subtitle", defaultValue: "Briefly flash a blue outline when deppy-mux highlights a pane.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: (telemetryAtAppear != nil && telemetry.current != telemetryAtAppear)
                    ...
                    : String(localized: "settings.app.telemetry.subtitle", defaultValue: "Share anonymized crash and usage data to help improve deppy-mux.")
            ) {
