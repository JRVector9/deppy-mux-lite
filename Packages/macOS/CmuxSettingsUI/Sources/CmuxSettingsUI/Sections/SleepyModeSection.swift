            ...
            SettingsCard {
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.theme) {
                        Text(String(localized: "sleepyMode.theme.cmux", defaultValue: "deppy-mux")).tag(SleepyTheme.cmux)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.mascot) {
                        Text(String(localized: "sleepyMode.mascot.cmux", defaultValue: "deppy-mux mascot")).tag(SleepyMascot.cmux)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.glow) {
                        ...
                        Text(String(localized: "sleepyMode.glow.cmux", defaultValue: "deppy-mux")).tag(SleepyGlow.cmux)
