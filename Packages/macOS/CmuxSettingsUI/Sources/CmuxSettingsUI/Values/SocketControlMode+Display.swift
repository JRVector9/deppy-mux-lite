...
extension SocketControlMode {
    ...
    var displayName: String {
        ...
        case .cmuxOnly:
            return String(localized: "socketControl.cmuxOnly.name", defaultValue: "deppy-mux processes only")
        case .automation:
    ...
    var description: String {
        ...
        case .cmuxOnly:
            return String(localized: "socketControl.cmuxOnly.description", defaultValue: "Only processes started inside deppy-mux terminals can send commands.")
        case .automation:
