    ...
    static func content(for gate: MobileSetupGuidanceState) -> SetupHelpGateContent {
        ...
        case .notSignedIn:
            return SetupHelpGateContent(
                ...
                body: L10n.string(
                    ...
                    defaultValue: "Sign in to dodomux on this phone with the same account your Mac uses. Without that, there is nothing to connect to."
                ),
                link: nil,
        ...
        case .signedInNeverPaired:
            return SetupHelpGateContent(
                ...
                title: L10n.string("mobile.setupHelp.macAppTitle", defaultValue: "Run dodomux on your Mac"),
                body: L10n.string(
                    "mobile.setupHelp.macAppBody",
                    defaultValue: "Install the dodomux Mac app and leave it running, signed in to the same account. The phone pairs to a running Mac, so a quit or never-installed app is the most common reason pairing does nothing."
                ),
                link: SetupHelpGateLink(
                    title: L10n.string("mobile.setupHelp.macAppLink", defaultValue: "Download dodomux for Mac"),
        ...
        case .macUnreachable:
            return SetupHelpGateContent(
                ...
                body: L10n.string(
                    ...
                    defaultValue: "You have paired this Mac before but it is not reachable now. Wake it, make sure dodomux is running, and confirm both devices are on the same tailnet or Wi-Fi. Then reconnect."
                ),
                link: nil,
        ...
        case .accountMismatch:
            return SetupHelpGateContent(
                ...
                body: L10n.string(
                    ...
                    defaultValue: "If the Mac rejects this device's sign-in, the two are on different dodomux accounts or this device's session is stale. Sign this phone in to the Mac's account (or sign the Mac in to this one), then pair again."
                ),
                link: nil,
