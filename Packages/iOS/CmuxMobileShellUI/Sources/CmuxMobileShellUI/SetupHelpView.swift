    ...
    private var networkSection: some View {
        Section {
            ...
            Text(L10n.string(
                ...
                defaultValue: "The Mac and this phone must be signed in to the same deppy-mux account, and on the same tailnet (or the same Wi-Fi for a manual local connection)."
            ))
        }
