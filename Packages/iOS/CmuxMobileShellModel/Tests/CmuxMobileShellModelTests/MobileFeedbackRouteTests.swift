...
struct MobileFeedbackRouteTests {
    ...
    @Test func debugBuildIsAlwaysDev() {
        #expect(MobileBuildType.resolve(isDebugBuild: true, bundleIdentifier: "dev.deppy-mux.app.beta") == .dev)
    ...
    @Test func releaseBetaBundleIsBeta() {
        #expect(MobileBuildType.resolve(isDebugBuild: false, bundleIdentifier: "dev.deppy-mux.app.beta") == .beta)
