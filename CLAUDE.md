...
- **Shortcut policy:** Every new cmux-owned keyboard shortcut must be added to `KeyboardShortcutSettings`, visible/editable in Settings, supported in `~/.config/deppy-mux/deppy-mux.json`, and documented in the keyboard shortcut and configuration docs.
